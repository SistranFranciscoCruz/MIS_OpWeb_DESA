...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_principal" runat="Server">
            ...
            <ContentTemplate>
                ...
                <div class="panel-contenido ventana1">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn botones" id="btn_Recuperar_lote" style="border-width: 2px; text-align: center">
                                <span>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <asp:TextBox ID="txtFechaEstimadaPago" AutoPostBack="True" OnTextChanged="txt_TextChanged" runat="server" CssClass="estandar-control fechadepago Fecha Centro" autocomplete="off" placeholder="DD/MM/YYYY"></asp:TextBox>
                        </div>
    ...
    <div style="width: 100%; text-align: right; border-top-style: inset; border-width: 1px; border-color: #003A5D">
        <div class="padding10">
            ...
            <button type="button" class="btn botones Centrado" id="btn_Reporte" style="border-width: 2px">
                <span>
                    <img class="btn-buscar" />
                    &nbsp Buscar
                </span>
    ...
    <div style="width: 100%; text-align: right; border-width: 1px; border-color: #003A5D">
        <div class="padding10">
            ...
            <button type="button" class="btn botones pull-right hidden" id="btn_Guardar">
                <span>
    ...
    <div id="Modal" class="modal-catalogo">
        <div class="cuadro-titulo-flotante">
            ...
            <div>
                <label id="lbl_Catalogo">Generacion de Ordenes de Pago</label></div>
        </div>
        ...
        <asp:UpdatePanel runat="server" ID="upCatalogo">
            <ContentTemplate>
                <div class="input-group">
                    ...
                    <%--<asp:HiddenField runat="server" ID="hid_cta2" Value="" />--%> <%--//>VZAVALETA_10290_CC7--%>
                    <br />
    ...
    <div id="CatalogoTerceros" style="padding-left: 0px;" class="modal-catalogo ">
        ...
        <div class="row" style="padding-left: 50px; padding-right: 50px;">
            ...
            <table id="grdTercero" style="width: 455px; height: 280px">
            </table>
        ...
        <div style="width: 100%; text-align: right;">
            ...
            <asp:Button runat="server" ID="Button3" class="btn botones" Text="Cancelar" data-dismiss="modal" />
        </div>
        <div class="padding10" />
