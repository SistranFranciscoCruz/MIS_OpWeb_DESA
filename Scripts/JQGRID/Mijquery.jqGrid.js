    ...
    $.jgrid.extend({
        ...
        columnChooserFondosAseg: function (opts) {
            ...
            $.each(colModel, function (i) {
                ...
                if (colNames[i] != "") {
                    if (colNames[i] == "Folio Onbase" || colNames[i] == "Num Pago" || colNames[i] == "Tipo de comprobante" || colNames[i] == "Pagar A" || colNames[i] == "Codigo" || colNames[i] == "RFC" || colNames[i] == "Nombre /Razon Social" || colNames[i] == "Siniestro" || colNames[i] == "Subsinientro" || colNames[i] == "Moneda" || colNames[i] == "Tipo de Cambio" || colNames[i] == "Reserva" || colNames[i] == "Moneda de Pago" || colNames[i] == "Importe" || colNames[i] == "Deducible" || colNames[i] == "Concepto Facturado" || colNames[i] == "Concepto de pago" || colNames[i] == "Clase de Pago" || colNames[i] == "Tipo de Pago" || colNames[i] == "Concepto 2" || colNames[i] == "Tipo de Pago" || colNames[i] == "Folio Onbase Estado de cuenta" || colNames[i] == "Cuenta Bancaria" || colNames[i] == "Confirmar Cuenta" || colNames[i] == "Solicitante" || colNames[i] == "Notas" || colNames[i] == "Observaciones" || colNames[i] == "Accion") {
                        select.append("<option value='" + i + "' " +
                            (this.hidden ? "" : "selected='selected'") + ">" + $.jgrid.stripHtml(colNames[i]) + "</option>");
                    }
                }
        ...
        columnChooserFondosTer: function (opts) {
            ...
            $.each(colModel, function (i) {
                ...
                if (colNames[i] != "") {
                    if (colNames[i] == "Folio Onbase" || colNames[i] == "Num Pago" || colNames[i] == "Tipo de comprobante" || colNames[i] == "Pagar A" || colNames[i] == "Codigo" || colNames[i] == "RFC" || colNames[i] == "Nombre /Razon Social" || colNames[i] == "Alta Tercero" || colNames[i] == "Siniestro" || colNames[i] == "Subsinientro" || colNames[i] == "Moneda" || colNames[i] == "Tipo de Cambio" || colNames[i] == "Reserva" || colNames[i] == "Moneda de Pago" || colNames[i] == "Importe" || colNames[i] == "Deducible" || colNames[i] == "Concepto Facturado" || colNames[i] == "Concepto de pago" || colNames[i] == "Clase de Pago" || colNames[i] == "Tipo de Pago" || colNames[i] == "Concepto 2" || colNames[i] == "Tipo de Pago" || colNames[i] == "Folio Onbase Estado de cuenta" || colNames[i] == "Cuenta Bancaria" || colNames[i] == "Confirmar Cuenta" || colNames[i] == "Solicitante" || colNames[i] == "Notas" || colNames[i] == "Observaciones" || colNames[i] == "Accion") {
                        select.append("<option value='" + i + "' " +
                            (this.hidden ? "" : "selected='selected'") + ">" + $.jgrid.stripHtml(colNames[i]) + "</option>");
                    }
                }
        ...
        columnChooserTradAseg: function (opts) {
            ...
            $.each(colModel, function (i) {
                ...
                if (colNames[i] != "") {
                    if (colNames[i] == "Folio Onbase" || colNames[i] == "Num Pago" || colNames[i] == "Tipo de comprobante" || colNames[i] == "Pagar A" || colNames[i] == "Codigo" || colNames[i] == "RFC" || colNames[i] == "Nombre /Razon Social" || colNames[i] == "Siniestro" || colNames[i] == "Subsinientro" || colNames[i] == "Moneda" || colNames[i] == "Tipo de Cambio" || colNames[i] == "Reserva" || colNames[i] == "Moneda de Pago" || colNames[i] == "Importe" || colNames[i] == "Deducible" || colNames[i] == "Concepto Facturado" || colNames[i] == "Clase de Pago" || colNames[i] == "Concepto de pago" || colNames[i] == "Tipo de Pago" || colNames[i] == "Concepto 2" || colNames[i] == "Tipo de Pago" || colNames[i] == "Folio Onbase Estado de cuenta" || colNames[i] == "Cuenta Bancaria" || colNames[i] == "Confirmar Cuenta" || colNames[i] == "Solicitante" || colNames[i] == "Notas" || colNames[i] == "Observaciones" || colNames[i] == "Accion") {
                        select.append("<option value='" + i + "' " +
                            (this.hidden ? "" : "selected='selected'") + ">" + $.jgrid.stripHtml(colNames[i]) + "</option>");
                    }
                }
        ...
        columnChooserTradTer: function (opts) {
            ...
            $.each(colModel, function (i) {
                ...
                if (colNames[i] != "") {
                    if (colNames[i] == "Folio Onbase" || colNames[i] == "Num Pago" || colNames[i] == "Tipo de comprobante" || colNames[i] == "Pagar A" || colNames[i] == "Codigo" || colNames[i] == "RFC" || colNames[i] == "Nombre /Razon Social" || colNames[i] == "Alta terceros" || colNames[i] == "Siniestro" || colNames[i] == "Subsinientro" || colNames[i] == "Moneda" || colNames[i] == "Tipo de Cambio" || colNames[i] == "Reserva" || colNames[i] == "Moneda de Pago" || colNames[i] == "Importe" || colNames[i] == "Deducible" || colNames[i] == "Concepto Facturado" || colNames[i] == "Clase de Pago" || colNames[i] == "Concepto de pago" || colNames[i] == "Tipo de Pago" || colNames[i] == "Concepto 2" || colNames[i] == "Tipo de Pago" || colNames[i] == "Cuenta Bancaria" || colNames[i] == "Confirmar Cuenta" || colNames[i] == "Solicitante" || colNames[i] == "Notas" || colNames[i] == "Observaciones" || colNames[i] == "Accion") {
                        select.append("<option value='" + i + "' " +
                            (this.hidden ? "" : "selected='selected'") + ">" + $.jgrid.stripHtml(colNames[i]) + "</option>");
                    }
                }
